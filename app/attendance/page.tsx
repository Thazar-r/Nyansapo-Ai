...
import { Search, Filter, Home, User, BookOpen, Users, Calendar, CheckCircle, XCircle } from "lucide-react"
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-300">Class {i}</p>
                    </div>
                  </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-[#0F2563] py-3">
          <div className="flex justify-around items-center">
            ...
            <Link href="/attendance" className="flex flex-col items-center">
              ...
              <span className="text-xs mt-1 text-yellow-400">Attendance</span>
            </Link>
          </div>
        </div>
      </div>
